Cette section s'intéresse au Table Filling Algorithm, défini dans la sous-section \ref{tfa:tfa}. Cependant, celui-ci utilise la relation \rf de la section \ref{tfa:re}.
