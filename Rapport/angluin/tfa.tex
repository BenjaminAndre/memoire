Cette section s'intéresse au Table Filling Algorithm, défini dans la sous-section \ref{ss:tfa}. Cependant, celui-ci utilise la relation \rf de la section \ref{ss:re}.
