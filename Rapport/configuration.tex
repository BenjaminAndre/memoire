...
\usepackage[framed, amsthm, hyperref,standard,thmmarks]{ntheorem}
\usepackage{lmodern}
...
\newtheorem*{complexity}{Complexité}

\renewtheorem{proof}{Preuve}

\renewtheorem{theorem}{Théorème}
\renewtheorem{example}{Exemple}
\renewtheorem{lemma}{Lemme}
\renewtheorem{corollary}{Corollaire}
