...
\begin{proof}
	...
	Posons $E_{ij}^k$ l'expression régulière décrivant un langage constitué des mots $w$ tels que $\delta(i,w)=j$ et qu'aucun état intermédiaire n'ait un nombre supérieur à $k$. Il n'y a pas de contrainte sur $i$ et $j$.
