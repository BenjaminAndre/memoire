...
\begin{document}
	...
	\section{Bases théoriques}\label{sec:theorie}\input{bases_theoriques}
	 
	 
	\section{Algorithmes}\label{sec:algorithmes}\input{algorithmes}
	
	
	\section{Preuves}\label{sec:preuves}\input{preuves}
