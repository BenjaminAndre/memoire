...
\begin{document}
	...
	\section{Problème}\label{sec:prob}%explication du problème et de la solution générale proposée par le papier
	...
	\section{États insécures}\label{sec:unsafe}%W(L) et tout ce qu'il faut pour le calculer
