...
\begin{figure}[H]
	...
	;
	\end{tikzpicture}
	\caption{Automate $D$. De par la construction par les parties de $Q$, le nombre de partie est exprimé en exponentiel, d'où la complexité du graphe. Ici, $\{q_0,q_2\}$ n'est pas atteignable et peut être supprimé.}\label{fig:dndf}
\end{figure}
\end{exemple}
